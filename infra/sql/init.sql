...
('Lucas', 'Silva', '2005-03-15', 'Rua das Flores, 123', 'lucas.silva@email.com', '(11) 91234-5678'),
('Mariana', 'Oliveira', '2004-07-22', 'Av. Brasil, 456', 'mariana.oliveira@email.com', '(11) 92345-6789'),
('Pedro', 'Santos', '2006-01-10', 'Rua do Sol, 789', 'pedro.santos@email.com', '(11) 93456-7890'),
('Ana', 'Costa', '2005-11-05', 'Rua das Acácias, 321', 'ana.costa@email.com', '(11) 94567-8901'),
('Rafael', 'Ferreira', '2003-09-30', 'Av. Paulista, 654', 'rafael.ferreira@email.com', '(11) 95678-9012'),
('Beatriz', 'Martins', '2004-05-18', 'Rua Verde, 987', 'beatriz.martins@email.com', '(11) 96789-0123'),
('João', 'Almeida', '2005-12-25', 'Rua Azul, 159', 'joao.almeida@email.com', '(11) 97890-1234'),
('Camila', 'Rodrigues', '2006-06-09', 'Av. Central, 753', 'camila.rodrigues@email.com', '(11) 98901-2345'),
('Gustavo', 'Lima', '2004-02-28', 'Rua do Campo, 852', 'gustavo.lima@email.com', '(11) 99012-3456'),
('Isabela', 'Souza', '2003-08-14', 'Rua das Palmeiras, 147', 'isabela.souza@email.com', '(11) 90123-4567');
...
(1, 3, '2025-09-01', '2025-09-15', 'Em andamento'),
(2, 5, '2025-09-03', '2025-09-17', 'Em andamento'),
(3, 1, '2025-09-05', '2025-09-19', 'Em andamento'),
(4, 7, '2025-09-07', '2025-09-21', 'Em andamento'),
(5, 2, '2025-09-09', '2025-09-23', 'Em andamento'),
(6, 4, '2025-09-11', '2025-09-25', 'Em andamento'),
(7, 6, '2025-09-13', '2025-09-27', 'Em andamento'),
(8, 9, '2025-09-15', '2025-09-29', 'Em andamento'),
(9, 8, '2025-09-17', '2025-10-01', 'Em andamento'),
(10, 10, '2025-09-19', '2025-10-03', 'Em andamento');
